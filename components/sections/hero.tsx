  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="hero-editorial-center">
          ...
          <div className="relative z-[10] hero-fade-in hero-delay-2 flex items-end justify-center" style={{ height: "100vh" }}>
            ...
            <Image
              ...
              width={700}
              height={700}
              className="relative z-10 object-contain h-[88vh] w-auto jett-glow"
              priority
            />
          </div>
      ...
      <div className="lg:hidden relative">
        <div className="flex flex-col gap-6 pt-24 pb-16 min-h-screen justify-center px-4 sm:px-6">

          {/* Headline */}
          <div className="hero-fade-in">
            <h1 className="text-5xl sm:text-6xl font-black uppercase tracking-tight leading-[0.9] text-text-primary">
              DOMINE
              <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-amber-500">
                CADA

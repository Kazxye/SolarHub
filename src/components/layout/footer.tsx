      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-text-secondary text-sm max-w-sm">
              A plataforma mais confiável para scripts de VALORANT.
              Qualidade, segurança e suporte que você merece.
            </p>
            <div className="mt-6 flex items-center gap-4">
              <a
                href="#"
                className="p-2 rounded-lg bg-surface hover:bg-surface-hover border border-border text-text-secondary hover:text-text-primary transition-colors"
                aria-label="Discord"
              >
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-text-secondary">
            © {new Date().getFullYear()} SolarHub. Todos os direitos reservados.
          </p>

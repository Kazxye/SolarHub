...
export function Showcase() {
  return (
    <section id="showcase" className="relative overflow-hidden">
      ...
      {/* Section fades — pointer-events-none so CTA below stays clickable */}
      <div className="absolute top-0 left-0 right-0 h-24 bg-gradient-to-b from-background to-transparent z-[25] pointer-events-none" />
      <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-background to-transparent z-[25] pointer-events-none" />
      ...
      <div className="lg:hidden relative">
        <div className="flex flex-col gap-4 pt-16 pb-16 min-h-[85vh] justify-center px-4 sm:px-6">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 hero-fade-in hero-delay-2">
            <a href="https://discord.gg/solarhub" target="_blank" rel="noopener noreferrer">
              <Button size="lg" className="h-12 text-base px-8 w-full sm:w-auto">
                Entrar no Discord
                <ArrowUpRight className="w-4 h-4" />
              </Button>
            </a>

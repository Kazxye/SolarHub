        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-screen flex items-center">
          <div className="grid lg:grid-cols-12 gap-6 lg:gap-8 items-center w-full pt-28 pb-16 lg:pt-0 lg:pb-0">
            ...
            <div className="lg:col-span-6 xl:col-span-7 relative flex items-center justify-center lg:justify-end">
              <div className="relative hero-fade-in hero-delay-2 esp-container w-full max-w-[500px] sm:max-w-[600px] lg:max-w-none">
                ...
                <Image
                    ...
                    width={800}
                    height={800}
                    className="esp-character relative z-10 object-contain h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[80vh] xl:h-[85vh] w-auto mx-auto"
                    priority
                />
                ...
                {/* Mobile ESP — simplified corners only */}
